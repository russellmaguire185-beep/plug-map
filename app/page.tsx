...
export default function Home() {
  ...
  return (
    <main className="min-h-screen px-4 py-10 text-white sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/20 bg-slate-950/60 backdrop-blur-xl p-8 shadow-2xl backdrop-blur-xl">
        ...
        <div className="mt-8 grid gap-3 lg:grid-cols-[1fr_220px_180px]">
          <input
            type="text"
            ...
            className="rounded-2xl border border-white/20 bg-white/90 px-5 py-4 text-base text-slate-900 outline-none"
          />
          <select
            value={category}
            onChange={(e) => setCategory(e.target.value)}
            className="rounded-2xl border border-white/20 bg-white/90 px-4 py-4 text-sm text-slate-900 outline-none"
          >
